          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-blue-300 drop-shadow-lg">perfectas</span>{" "}
                para tu proyecto
              </motion.h1>
              <motion.p
          ...
          <section id="funcionalidades" className="px-6 py-24">
            <div className="max-w-5xl mx-auto">
              <motion.div
                  ...
                  variants={fadeInUp}
              >
              <span className="text-sm font-semibold text-primary dark:text-blue-300 uppercase tracking-wider">
                Funcionalidades
              </span>
                ...
                {HOW_IT_WORKS.map((step, i) => (
                    ...
                    >
                      <div className="flex items-center gap-3 mb-4">
                        <motion.span
                            className="text-4xl font-bold text-primary dark:text-blue-300 font-serif"
                        ...
                        {i < HOW_IT_WORKS.length - 1 && (
                            <motion.div
                                className="hidden md:block h-px flex-1 bg-primary/30 dark:bg-blue-300/30"
                                initial={{ scaleX: 0 }}
                ...
                >
                  {["Sin tarjeta de crédito", "Cancela cuando quieras", "Soporte en español"].map((t) => (
                      <motion.span
                          ...
                          variants={fadeInUp}
                      >
                        <CheckCircle2 className="w-3.5 h-3.5 text-primary dark:text-blue-300" />
                        {t}
                      </motion.span>
                  ))}
                </motion.div>
