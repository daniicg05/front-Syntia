      ...
      <Card>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea rows={5} className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500" {...register("descripcion")} />
          </div>
