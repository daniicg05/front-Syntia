...
function EmptyState() {
  ...
  const themedPrimaryText = theme === "dark" ? "text-blue-300" : "text-white";
  ...
  return (
      <div className="text-center py-16">
        ...
        <Link
            ...
            className={`inline-flex items-center gap-2 bg-primary px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-primary-hover transition-colors ${themedPrimaryText}`}
        >
...
export default function ProyectosPage() {
  ...
  const themedPrimaryOnSolid = theme === "dark" ? "text-blue-300" : "text-white";
  ...
  return (
      <div>
        ...
        >
          ...
          <Link
              href="/proyectos/nuevo"
              className={`inline-flex items-center gap-2 bg-primary px-4 py-2.5 rounded-xl hover:bg-primary-hover font-semibold text-sm transition-all shadow-sm shrink-0 ${themedPrimaryOnSolid}`}
          >
            <Plus className="w-4 h-4" />
            Nuevo proyecto
          </Link>
                        ...
                        <Card className="flex flex-col h-full">
                          ...
                          {(proyecto.sector || presupuestoFmt) && (
                            ...
                            <Tag className="w-3 h-3" />
                                ...
                                {presupuestoFmt && (
                                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-primary-light ${themedPrimaryText}`}>
                          ...
                          <div className="mt-4 pt-4 border-t border-border">
                            <Link
                                ...
                                className={`flex items-center justify-center gap-1.5 w-full py-2.5 px-3 rounded-xl text-sm font-semibold bg-primary-light hover:bg-primary transition-all duration-200 ${themedPrimaryText} hover:text-white`}
                            >
                              Ver subvenciones
