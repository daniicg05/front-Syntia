  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <h1 className="text-2xl font-bold text-foreground">Convocatorias ({convocatorias.length})</h1>
        <div className="flex gap-2">
          <Button variant="secondary" onClick={importar} loading={importando} icon={<Download className="h-4 w-4" />}>
            Importar BDNS
          </Button>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-surface-muted border-b border-border">
              <tr>
                <th className="text-left px-4 py-3 font-medium text-foreground-muted">Título</th>
                ...
                <tr key={c.id} className="hover:bg-surface-muted transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-2">
                      ...
                      <Button variant="danger" size="sm" onClick={() => eliminar(c.id)}>
