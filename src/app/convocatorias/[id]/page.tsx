...
import { ArrowLeft, Bot, Briefcase, Building2, CalendarDays, ChevronDown, CircleHelp, Download, FileText, Hash, Lock, MapPin, Sparkles, Star, Users } from "lucide-react";
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-border bg-white p-4">
              ...
              <div className="mt-3 flex items-center justify-between gap-4">
                ...
                <div className="h-14 w-14 shrink-0 rounded-2xl bg-primary inline-flex items-center justify-center shadow-sm">
