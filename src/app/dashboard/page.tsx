          ...
          <Card>
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                  ...
                  className={`shrink-0 inline-flex items-center gap-1.5 text-xs font-semibold hover:underline ${
                      ...
                      return (
                          <button
                              ...
                              className={`w-full text-left p-3 rounded-xl border transition-colors ${
                                  isSelected
                                      ? "border-sky-300 bg-primary-light"
                            ...
                            {proyecto.sector && (
                                <p
                                    className={`text-xs mt-1 line-clamp-1 ${
                                        isSelected ? "text-black/80" : "text-foreground-muted"
                                    }`}
                                >
                                  {proyecto.sector}
                                </p>
